...
public class Person {
    ...
    public void setAge(int age) {
        this.age = (age < 0 || age > 100) ? 0 : age; // ?: is a ternary operator that follows (condition ? value_if_true : value_if_false). can also be used in assignment as (variable = condition ? value_if_true : value_if_false) used as a conditional (if-then-else)
    }
