public class Main {
    ...
    public static void main(String[] args) {
        ...
        calculateScore(75);
        calculateScore();
        calcFeetAndInchesToCentimetres(10, -10); //calling a method
...
//CODING CHALLENGE
    ...
    public static double calcFeetAndInchesToCentimetres(double feet, double inches) {
        ...
        double centimetres = (feet * 12) * 2.54; //converting feet to incyhes then to centimetres
        centimetres = centimetres + (inches * 2.54);
    ...
    //CODING CHALLENGE: SecondsAndMinutes
